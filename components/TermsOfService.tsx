    ...
    <div className="min-h-screen bg-royal-950 p-4 md:p-8 pb-24">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="glass-panel p-8 rounded-2xl border border-white/10 bg-royal-900/50 relative overflow-hidden">
                ...
                {/* Replaced prose-invert with manual styling using dynamic text-slate-200/text-white */}
                <div className="text-sm max-w-none text-slate-200 space-y-6">
                    ...
                    <section>
                        <h3 className="text-white font-bold text-lg mb-2">2. Eligibility</h3>
                        <p className="leading-relaxed">
                    ...
                    <section>
                        <h3 className="text-white font-bold text-lg mb-2">3. P2P Gaming & Escrow</h3>
                    ...
                    <section>
                        <h3 className="text-white font-bold text-lg mb-2">4. Fair Play & AI Referee</h3>
                        <p className="leading-relaxed mb-2">
                    ...
                    <section>
                        <h3 className="text-white font-bold text-lg mb-2">5. Deposits & Withdrawals</h3>
                        <p className="leading-relaxed">
